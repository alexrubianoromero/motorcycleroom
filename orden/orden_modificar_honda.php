    ...
    <table border = "1"  width = "75%">
      ...
      <tr>
        <td height="80" colspan="11"><label>
          <textarea name="descripcion_orden"  id = "descripcion_orden" cols="90" rows="4"> <?php  echo $datos[0]['observaciones']?>
    </textarea>
        </label></td>
      </tr>
    </table>	
  <br>
  BUSCAR CODIGO POR DESCRIPCION 
...
<button id="actualizar_orden" > ACTUALIZAR INFORMACION </button>
</h2> 
 </td>
</tr>
</table>
					...
					$("#cambiar_placa").click(function(event) {
					  ...
					  /*
						$("#buscar_codigo").click(function(){
							$("#busqueda_codigos").css("display","block");
