...
<table width="95%" border="1">
  ...
  <table width="95%" border="1">
  <tr style="background-color: #c0c0c0;"><td><div align="center"> REPUESTOS</div> </td></tr>
  </table>
...
<tr>
	 <td>&nbsp;</td> 
 	<td>&nbsp;</td> 
 	<td style="background-color: #DEE3E3;" >Subtotal Repuestos</td>
 	<td style="background-color: #DEE3E3;" align="right"><?php  echo number_format($subtotal_repuestos1, 0, ',','.')   ?></td> 
</tr>

<tr style="background-color: #c0c0c0;">
	<td></td>
	<td colspan="2" align="center">MANOS DE OBRA</td>
...
<td>&nbsp;</td> 
<td>&nbsp;</td> 
<td style="background-color: #DEE3E3;" >Subtotal manos de obra</td>
<td style="background-color: #DEE3E3;" align="right"><?php  echo number_format($subtotal_mano_obra, 0, ',','.')   ?></td> 
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td style="background-color: #9A9D9D;" >TOTAL REPUESTO Y MANO DE OBRA </td>
	<?php
