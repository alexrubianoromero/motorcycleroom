...
echo '<table border= "1">';
	...
	</td><td><h3>Placa</h3></td><td><h3>Tecnico</h3></td><td><h3>Mano Obra</h3></td><h3>Subtotal</h3></td><td><h3>Total</h3></td>';
	echo '</tr>';
		...
		while($ordenes = mysql_fetch_array($consulta_ordenes))
			{
				...
				$subtotal_mano_obra = muestre_items_local_repuestos($ordenes['0'],$tabla15,$conexion,$_SESSION['id_empresa'],$tabla12,'MO');
