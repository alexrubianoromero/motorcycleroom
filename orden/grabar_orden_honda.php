...
$sql_grabar_orden = "insert into $tabla14 (orden,placa,sigla,fecha,observaciones,radio,antena,repuesto,herramienta,otros,
	iva,id_empresa,estado,kilometraje,mecanico,tipo_orden,kilometraje_cambio,fecha_entrega,notificacion,gasolina,usuario_creacion,cotiza) 
values (
'".$ordenpan."',
'".$_POST['placa']."',
'".$_POST['clave']."',
...
*/
$body = '
Te damos la bienvenida a MOTORCYCLE ROOM <br>

De antemano queremos agradecer tu confianza en nosotros, y en respuesta a ello hemos dispuesto de los mejores tecnicos, insumos y experiencia, para satisfacer completamente tus requerimientos hacia nuestro servicio. 
<br>
...
Recuerda, estamos ubicados en la Av. calle 80 22-59 <br>';
