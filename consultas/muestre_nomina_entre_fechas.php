...
echo '<div id="muestre_resumen" align="center">';
echo '<a style="font-size:20px;" href="muestre_nomina_entre_fechas_excell.php?fechain='.$_REQUEST['fechain'].'&fechafin='.$_REQUEST['fechafin'].'&modo='.$_REQUEST['modo'].'" target="_blank">Enviar A Excell</a>';
echo '<br><br>';
