...
<?php	
		...
		echo '<tr><td><h8>CANT.</h8></td><td><h8>DESCRIPCION</h8></td><td><h8>PRECIO UNI</h8></td><td><h8>PRECIO TOTAL </h8></td><td><h8>IVA</h8></td>
		...
		while($items = mysql_fetch_array($consulta_items))
			{
				...
				echo '<td> <input type = "text"  id = "porcentaje_'.$i.'" name = "porcentaje_'.$i.'"  value =  "'.$valor_porcentaje_iva.'"  class="recalcular" ></td>';
